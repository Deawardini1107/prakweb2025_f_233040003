<x-layout>
    ...
    <form action="/posts/{{ $post->id }}" method="POST" style="max-width: 600px;">
        @csrf
        @method('PUT')
        ...
        <div style="margin-top: 20px;">
            <button type="submit" style="background: #ffc107; color: black; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer; margin-right: 10px;">Update Post</button>
